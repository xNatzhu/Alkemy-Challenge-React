...
export default function Listado(props) {
    ...
    useEffect(()=>{
        const url = "https://api.themoviedb.org/3/discover/movie?api_key=9c248bca4eebe0191e41b369be0c2aa6&language=es-ES&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate";
    ...
    return(
        <div className="container">
            ...
            <div className="row card-conteiner-main">
                ...
                <>
                    <div>
                        <div className="mb-5 container-search">
                            <h3 className="app_listado_section_title mt-5 mb-5">Explora las <span>películas</span> mas recientes </h3>

                            <Buscador arrayFavorite={props}/>
                        </div>
